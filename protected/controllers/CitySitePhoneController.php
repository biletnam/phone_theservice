...
class CitySitePhoneController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('CitySitePhone');
	 ...
	 * @param CitySitePhone $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='city-site-phone-form')
		{
